...
# где в бесконечном цикле запрашивали имя, личный идентификатор и уровень доступа 
# (от 1 до 7) сохраняя информацию в JSON файл. Напишите класс пользователя, который 
# хранит эти данные в свойствах экземпляра. Отдельно напишите функцию, которая считывает 
# информацию из JSON файла и формирует множество пользователей.
...
# магический метод проверки на равенство пользователей. Если 
# такого пользователя нет, вызывайте исключение доступа. А 
# если пользователь есть, получите его уровень из множества пользователей.
...
from task_3_sem_13 import ErrorAccess, ErrorLevel
...
#         if new_lvl < self.admin.lvl:
#             raise ErrorLevel
#         self.users.add(User(new_name, new_id, new_lvl))
...
#     def __eq__(self, _value: object):
#         return self.id == _value.id and self.name == _value.name
...
#         id = input("Введите id: ")
#         level = input("Введите level: ")
#         data(name, id, level, file_name)


# new_p = Project('users1.json')
# new_p.enter('qwer', '1')
# new_p.add_user("new_user", "11", "5")
# print(new_p.users)
...
# import json
# from error import ErrorAccess, ErrorLevel
